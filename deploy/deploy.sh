...
echo ""
echo "  Astronomy Shop:  kubectl port-forward svc/astronomy-shop-frontendproxy 8080:8080 -n astronomy-shop"
...
echo "                   APM > Services: look for astronomy-shop-demo environment"
echo "================================================================"
